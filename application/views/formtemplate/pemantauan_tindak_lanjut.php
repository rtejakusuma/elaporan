                                    ...
                                    <div>
                                      <div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea id="editor" name="rekomendasi[<?php echo $htemuan['id_temuan']; ?>][]"><?= $htemuan['rekomendasi']; ?></textarea>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea id="editor" name="tindak_lanjut[<?php echo $htemuan['id_temuan']; ?>][]"><?= $htemuan['tindak_lanjut']; ?></textarea>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea id="editor" name="catatan_bpk[<?php echo $htemuan['id_temuan']; ?>][]"><?= $htemuan['catatan_bpk']; ?></textarea>
    ...
    <div class='form-group'>\
      ...
      <div class='col-md-6 col-sm-6 col-xs-12'>\
        ...
        div > \\ <
          ...
          label
        for = 'tindak_lanjut'
        class = 'control-label col-md-3 col-sm-3 col-xs-12' > Tindak Lanjut < /label>\ <
        div class = 'col-md-6 col-sm-6 col-xs-12' > \
          <
          input class = 'form-control col-md-7 col-xs-12'
        type = 'text'
        name = 'tindak_lanjut["+id+"][]' > \
          <
          /div>\ < /
        div > \\ <
          div class = 'form-group' > \
          <
          label
        for = 'status_tindak_lanjut'
        class = 'control-label col-md-3 col-sm-3 col-xs-12' > Status Tindak Lanjut < /label>\ <
        div class = 'col-md-6 col-sm-6 col-xs-12' > \
          <
          select class = 'col-md-6 col-sm-6 col-xs-12'
        name = 'status_tindak_lanjut["+id+"][]' > \
          <?php
          echo "<option value='TS' $sel1>TS</option>";
          echo "<option value='TB' $sel2>TB</option>";
          echo "<option value='TT' $sel3>TT</option>";
        ...
        div class = 'form-group' > \
          ...
          label
        for = 'catatan_bpk'
        class = 'control-label col-md-3 col-sm-3 col-xs-12' > Catatan BPK < /label>\ <
        div class = 'col-md-6 col-sm-6 col-xs-12' > \
          <
          input class = 'form-control col-md-7 col-xs-12'
        type = 'text'
        name = 'catatan_bpk["+id+"][]' > \
          ...
          <
          button type = 'button'
        onclick = 'delete_hasil_temuan(this)' > Hapus < /button>\ < /
        div > \ <
          /div>\ < /
        div > < /div > < /div > ";
      }
