                 ...
                 <div class="x_content">
                   ...
                   <div class="" role="tabpanel" data-example-id="togglable-tabs">
                     <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                       ...
                       <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">RB Prioritas</a>
                       </li>
                       <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">RB Prioritas Sasaran</a>
                       </li>
                       <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">RB Prioritas Kegiatan</a>
                       </li>
                     </ul>
                     <div id="myTabContent" class="tab-content">
                       ...
                       <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action='<?php echo base_url("opd/e/$data[formname]/$data[id_laporan]"); ?>' method="post">
                         <input value="rb_prioritas" type="hidden" name="nama_tabel">
                           <button type='button' onclick='add_tab2()'>Tambah</button>
                           <div id='container-opsi'>

                           <?php if ($data['fetch']['rbp'] != NULL) {
                              foreach ($data['fetch']['rbp'] as $rbp) {
                           ?>
                           <div>
                           <div class="col-md-12 col-sm-12 col-xs-12" style='border: 2px solid black; padding:10px;'>
                           <input value='<?php echo $rbp['id_rb_prioritas']; ?>' type='hidden' name='id_rb_prioritas[]'>


                           <div class="form-group">
                             <label for="rincian" class="control-label col-md-3 col-sm-3 col-xs-12">Rincian</label>
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbp['rincian']))echo $rbp['rincian']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="rincian[]">
                             </div>
                           </div>
                       ...
                       <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                         <form id="demo-form3" data-parsley-validate class="form-horizontal form-label-left" action='<?php echo base_url("opd/e/$data[formname]/$data[id_laporan]"); ?>' method="post">
                          <input value="rb_prioritas_sasaran" type="hidden" name="nama_tabel">
                           
                           <div id='container-opsi'>

                           <?php if ($data['fetch']['rbps'] != NULL) {
                              foreach ($data['fetch']['rbp'] as $rbp) {
                           ?>
                           <div>
                           <div class="col-md-12 col-sm-12 col-xs-12" style='border: 2px solid black; padding:10px;'>
                           <input disabled value='<?php echo $rbp['id_rb_prioritas']; ?>' type='hidden' name='id_rb_prioritas[]'>
                            <h2><?php echo $rbp['rincian']; ?></h2>
                          ...
                          <div>
                           ...
                           <input value='<?php echo $rbps['id_rb_prioritas_sasaran']; ?>' type='hidden' name='id_rb_prioritas_sasaran[]'>
                           <input value='<?php echo $rbps['id_rb_prioritas']; ?>' type='hidden' name='id_rb_prioritas[]'>
                           <div class="form-group">
                             <label for="sasaran" class="control-label col-md-3 col-sm-3 col-xs-12">Sasaran</label>
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbps['sasaran']))echo $rbps['sasaran']; ?>'  class="form-control col-md-7 col-xs-12" type="text" name="sasaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input  value='<?php if(isset($rbps['nama_program']))echo $rbps['nama_program']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="nama_program[]">
                             </div>
                           </div>
                       ...
                       <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                         ...
                         <input value="rb_prioritas_kegiatan" type="hidden" name="nama_tabel">
                           <div id='container-opsi'>

                           <?php if ($data['fetch']['rbps'] != NULL) {             
                              foreach ($data['fetch']['rbps'] as $rbpss) {//printf("<pre>%s</pre>", json_encode($rbps, JSON_PRETTY_PRINT));
                                foreach($rbpss as $rbps){
                           ?>
                           <div>
                           <div class="col-md-12 col-sm-12 col-xs-12" style='border: 2px solid black; padding:10px;'>
                           <input disabled value='<?php echo $rbps['id_rb_prioritas_sasaran']; ?>' type='hidden' name='id_rb_prioritas_sasaran[]'>
                            <h2><?php echo $rbps['nama_program']; ?></h2>
                          ...
                          <input value='<?php echo $rbps['id_rb_prioritas_sasaran']; ?>' type='hidden' name='id_rb_prioritas_sasaran[]'>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['nama_kegiatan']))echo $rbpk['nama_kegiatan']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="nama_kegiatan[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['indikator']))echo $rbpk['indikator']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="indikator[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['target_output']))echo $rbpk['target_output']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_output[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['realisasi_output']))echo $rbpk['realisasi_output']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_output[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['target_waktu']))echo $rbpk['target_waktu']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_waktu[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['realisasi_waktu']))echo $rbpk['realisasi_waktu']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_waktu[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['target_anggaran']))echo $rbpk['target_anggaran']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_anggaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['realisasi_anggaran']))echo $rbpk['realisasi_anggaran']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_anggaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbpk['ket']))echo $rbpk['ket']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="ket[]">
                             </div>
                           </div>
...
function add_tab3(node) {
  ...
  var tab3 ="<div>\
           <div>\
           <input value='"+id+"' type='hidden' name='new[id_rb_prioritas][]'>\
           <div class='form-group'>\
            <label for='sasaran' class='control-label col-md-3 col-sm-3 col-xs-12'>Sasaran</label>\
                <div class='col-md-6 col-sm-6 col-xs-12'>\
...
function add_tab4(node) {
  ...
  var tab4 ="<div>\
           <div>\
           <input value='"+id+"' type='hidden' name='id_rb_prioritas_sasaran[]'>\
           <div class='form-group'>\
            <label for='nama_kegiatan' class='control-label col-md-3 col-sm-3 col-xs-12'>Nama Kegiatan</label>\
                <div class='col-md-6 col-sm-6 col-xs-12'>\
