                   ...
                   <div class="" role="tabpanel" data-example-id="togglable-tabs">
                     ...
                     <div id="myTabContent" class="tab-content">
                         ...
                         <form id="demo-form3" data-parsley-validate class="form-horizontal form-label-left" action='<?php echo base_url("opd/e/$data[formname]/$data[id_laporan]"); ?>' method="post">
                          ...
                          <button type='button' onclick='add_tab3(this)'>Tambah Sasaran & Program</button>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbks['sasaran']))echo $rbziwbks['sasaran']; ?>'  class="form-control col-md-7 col-xs-12" type="text" name="sasaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input  value='<?php if(isset($rbziwbks['nama_program']))echo $rbziwbks['nama_program']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="nama_program[]">
                             </div>
                           </div>
                       ...
                       <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                         ...
                         <input value="rb_zi_wbk_kegiatan" type="hidden" name="nama_tabel">
                           <div id='container-opsi'>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12" style='border: 2px solid black; padding:10px;'>
                           <input disabled value='<?php echo $rbziwbks['id_rb_zi_wbk_sasaran']; ?>' type='hidden' name='id_rb_zi_wbk_sasaran[]'>
                            <h2><?php echo $rbziwbks['nama_program']; ?></h2>
                          ...
                          <input value='<?php echo $rbziwbks['id_rb_zi_wbk_sasaran']; ?>' type='hidden' name='id_rb_zi_wbk_sasaran[]'>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['nama_kegiatan']))echo $rbziwbkk['nama_kegiatan']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="nama_kegiatan[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['indikator']))echo $rbziwbkk['indikator']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="indikator[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['target_output']))echo $rbziwbkk['target_output']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_output[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['realisasi_output']))echo $rbziwbkk['realisasi_output']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_output[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['target_waktu']))echo $rbziwbkk['target_waktu']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_waktu[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['realisasi_waktu']))echo $rbziwbkk['realisasi_waktu']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_waktu[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['target_anggaran']))echo $rbziwbkk['target_anggaran']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="target_anggaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['realisasi_anggaran']))echo $rbziwbkk['realisasi_anggaran']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="realisasi_anggaran[]">
                             </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input value='<?php if(isset($rbziwbkk['ket']))echo $rbziwbkk['ket']; ?>' class="form-control col-md-7 col-xs-12" type="text" name="ket[]">
                             </div>
                           </div>
...
function add_tab4(node) {
  ...
  var tab4 ="<div>\
           <div>\
           <input value='"+id+"' type='hidden' name='id_rb_zi_wbk_sasaran[]'>\
           <div class='form-group'>\
            <label for='nama_kegiatan' class='control-label col-md-3 col-sm-3 col-xs-12'>Nama Kegiatan</label>\
                <div class='col-md-6 col-sm-6 col-xs-12'>\
