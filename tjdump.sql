...
CREATE TABLE `kegiatan` (
  ...
  `kode_kegiatan2` varchar(30) DEFAULT NULL,
  ...
  KEY `fk_relationship_35` (`kode_kegiatan2`),
  CONSTRAINT `fk_relationship_35` FOREIGN KEY (`kode_kegiatan2`) REFERENCES `program` (`kode_kegiatan2`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `program` (
  `kode_kegiatan2` varchar(30) NOT NULL,
  `id_laporan` int(11) DEFAULT NULL,
...
-- Dump completed on 2019-07-31 11:53:05
